...
Migration `0003_runtime_role.sql` prepares a non-login, least-privilege role for the Lambda database identity. It intentionally excludes `DELETE`, object creation, grant delegation, and schema-wide future privileges. Live application of this migration remains an explicit gate.
