...
| Public video demonstrates the memory flow in under three minutes | Public video URL and manual review against the storyboard and redaction checklist | The Managed MCP recording gate is satisfied; a 2 minute 40 second storyboard is prepared in `DEVPOST_DRAFT.md`; the timed English narration, capture actions, and redaction review are prepared in `DEMO_VIDEO_SCRIPT.md` | Prepared | Record, review, upload, and add the URL |
